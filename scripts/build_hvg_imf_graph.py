"""
Script to transform an IMF into an HVG graph as a PyTorch Geometric Data object.

This script loads an IMF from a parquet file and transforms it into a Horizontal Visibility
Graph (HVG) as a PyTorch Geometric Data object.
"""

from pathlib import Path

from GraphEMD.data.graph_imf_transform_utils import build_hvg_imf_graph
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("IMF TO HVG GRAPH TRANSFORMATION")
    print("=" * 60)

    # Build the graph
    grafo = build_hvg_imf_graph(
    ...
    print("SUMMARY")
    print("=" * 60)
    print(f"HVG graph successfully created for {id_imf}")
