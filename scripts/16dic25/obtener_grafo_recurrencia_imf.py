"""
Script para transformar una IMF a grafo de recurrencia como objeto Data de PyTorch Geometric.

Este script carga una IMF desde un archivo parquet y la transforma a grafo de recurrencia
usando el método de delay embedding y matriz de recurrencia como un objeto Data de PyTorch Geometric.
"""

from pathlib import Path

from GraphEMD.data.graph_imf_transform_utils import obtener_grafo_recurrencia_imf
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("TRANSFORMACIÓN DE IMF A GRAFO DE RECURRENCIA")
    print("=" * 60)

    # Construir el grafo
    grafo = obtener_grafo_recurrencia_imf(
    ...
    print("RESUMEN")
    print("=" * 60)
    print(f"Grafo de recurrencia creado exitosamente para {id_imf}")
    ...
    print(f"  - Dimensión de embedding: {grafo.dim_embedding}")
    print(f"  - Algoritmo de distancia: {grafo.algoritmo_distancia}")
    print(f"  - Umbral de recurrencia: {grafo.umbral_recurrencia:.4f}")
