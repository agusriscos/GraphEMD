"""
Script para transformar una IMF a grafo NVG como objeto Data de PyTorch Geometric.

Este script carga una IMF desde un archivo parquet y la transforma a grafo Natural Visibility
Graph (NVG) como un objeto Data de PyTorch Geometric.
"""

from pathlib import Path

from GraphEMD.data.graph_imf_transform_utils import obtener_grafo_nvg_imf
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("TRANSFORMACIÓN DE IMF A GRAFO NVG")
    print("=" * 60)

    # Construir el grafo
    grafo = obtener_grafo_nvg_imf(
    ...
    print("RESUMEN")
    print("=" * 60)
    print(f"Grafo NVG creado exitosamente para {id_imf}")
